---
title: "Identifyng the leaf traits which influence plant reproductive mass fraction"
author: "Sam Majumder"
date: "1/17/2022"
...
########## METHOD 1 #### STEP AIC
set.seed(1234)
StepAIC <- train(WPRMF~.,data=train_standard,method="lmStepAIC",direction="both",trace=FALSE)
...
write.csv(importance_scores_AIC,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_2/Leaf_traits_driving_destructive_traits/Plant_reproductive_mass_fraction/M_regression/FEATURE_SELECTION/StepAIC_RMF.csv")
...
M_regression_new <- train(WPRMF~., data = train_new,method='lm',trControl=params)
...
write.csv(variables,"D:/Drive_C_2_18_21/PhD_WORK/Chapter_2/Leaf_traits_driving_destructive_traits/Plant_reproductive_mass_fraction/RFE/FEATURE_SELECTION/RFE_RFM_importance.csv")
